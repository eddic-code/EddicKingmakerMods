...
rem dll/pdb/Info.json (and Icons for EddicKingmaker) into the game's
...
for %%M in (EddicKingmaker EddicKingmakerBuffs EddicKingmakerLoot EddicKingmakerRespec) do (
